...
class App extends React.Component {
  ...
  render(){
    ...
    {this.state.showAddEditDiv && <div>
            ...
            <input type="text" name="enq_date" id="enq_date" placeholder="enter enqdate" required value={this.state.selectedRow.enq_date} onChange={(e)=>this.inpChange(e,'enq_date')}/><br/><br/>
